...
declare function readBrs(rawBytes: Uint8Array, options?: ReadOptions): ReadSaveObject;
declare function writeBrs(save: WriteSaveObject, options?: WriteOptions): Uint8Array;
declare global {
	interface Window {
		BRS: {
			read: typeof read;
...
export declare const read: typeof import("brs-js").read;
export declare const write: typeof import("brs-js").write;
export declare const utils: typeof import("brs-js/dist/src/utils");
export declare const constants: typeof import("brs-js/dist/src/constants");
export declare const _OMEGGA_UTILS_IMPORT: {
	...
	brick: {
		...
		rotate: (brick: import("brs-js").Brick, rotation: [
			number,
			number
		]) => import("brs-js").Brick;
		rotate_x: (times: number) => (obj: import("brs-js").Brick) => import("brs-js").Brick;
		rotate_y: (times: number) => (obj: import("brs-js").Brick) => import("brs-js").Brick;
		rotate_z: (times: number) => (obj: import("brs-js").Brick) => import("brs-js").Brick;
		d2o: (direction: number, rotation: number) => number;
		o2d: (orientation: number) => number[];
	};
	wsl: () => number;
	brs: typeof import("brs-js");
};
declare global {
...
export interface StaticPlayer {
	 ...
	 * @param item Item name (Weapon_Bow)
	 */
	takeItem(omegga: OmeggaLike, target: string | OmeggaPlayer, item: string): void;
}
